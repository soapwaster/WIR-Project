...
\section{Proposal}
The paper describes a new approach to compute similarity between documents and queries. It not only takes into account tf-idf, but also SIMILARITY among terms via a new formula.\\
